...
<div id="bottom" class="double-nav-bottom"></div>`,
    ...
    aE = ht.View.extend({
        ...
        async update() {
            const t = this;
            if (this.player = this.model.get("player"), this.chat = this.model.get("chat") || {}, this.model.get("chosenDateUserId") && (this.chat.mode = "browse"), this.player && (this.summaryTopComponent.model.set("player", this.player), this.chat.mode === "chat" ? (this.summaryTopComponent.model.set("mode", "CHAT"), this.summaryTopComponent.model.set("description", "Cliquez sur un joueur pour lui envoyer un message")) : this.chat.mode === "date" ? (this.summaryTopComponent.model.set("mode", "L'HEURE DU CHOIX"), this.summaryTopComponent.model.set("description", "Avec qui voulez-vous sortir ?")) : this.chat.mode === "browse" && this.model.get("chosenDateUserId") !== null && (this.summaryTopComponent.model.set("mode", "CHOIX EFFECTUE"), this.summaryTopComponent.model.set("description", "En attente des autres pour continuer"))), this.chat) {
                let e;
                if (this.client.isRole("player")) {
