        ...
        <div class="pt-page-off state-lobby bombintern-page">\r
            <div class="container">\r
                ...
                <form class="pure-form">\r
                    <button type="button" id="bombintern-startgame" class="button-bombintern button-xlarge pure-button pure-input-1">COMMENCER</button>\r
                    <button type="button" id="bombintern-stopcountdown" class="button-bombintern  button-xlarge pure-button pure-input-1">ANNULER</button>\r
                </form>\r
            </div>\r
        </div>\r
\r
    ...
    async update() {
        ...
        switch (Ae(".bombintern-page").css("background-color", v), n) {
                ...
                switch (Ae(".bombintern-rules").html(""), this.lastPuzzle = a, a) {
                    ...
                    case "WiredBomb":
                        if (this.$el.find("#bombintern-wiredbomb-triggers").html(""), this.buildRuleFolder(a, "bombintern-wiredbomb-rules"), i.triggers && i.triggers.length > 0) {
                            t = "<div class='bomb-header' id='button-header'><span>APPUYEZ SUR LES BOUTONS POUR COUPER LES FILS</span></div>";
                            for (let _ = 0; _ < i.triggers.length; ++_) {
                                const S = i.triggers[_],
                                    O = S.name || "Fil";
            ...
            case "DayEnd":
                switch (a) {
                    case "DayEndDecision":
                        this.$el.find("#bombintern-dayend-text").html("Jour terminé !"), this.showScreen(".state-dayend");
                        break;
                    default:
                        this.$el.find("#bombintern-message-text").html("Jour terminé !"), this.showScreen(".state-message");
                        break
                }
                break;
            case "GameOver":
    ...
    async buildRuleFolder(t, e) {
        ...
        if (a.rules && a.rules.length > 0 || a.sort && a.sort.length > 0) {
            switch (n += "<div class='bomb-header' id='instruction-header'>", t) {
                case "SmashPuzzle":
                    n += "<span>LISEZ LES INSTRUCTIONS CI-DESSOUS</span>";
                    break;
                case "WiredBomb":
                    n += "<span>SUIVEZ LES INSTRUCTIONS</span>";
                    break;
                case "CoffeeBomb":
                    n += "<span>SUIVEZ LES INSTRUCTIONS</span>";
                    break;
            ...
            if (n += "</div>", n += "<div class='rules-folder-tab'><span>MANUEL</span></div><div class='rules-folder'>", t === "FilingBomb") n += `<div class='rules-page'><span>${a.sort}</span></div>`;
            ...
            case "SmashPuzzle":
                n += "<div class='bomb-header' id='instruction-header'><span>VOUS ETES LE SMASHEUR !</span></div>";
                break;
            case "WiredBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>VOUS ETES LE DESAMORCEUR !</span></div>";
                break;
            case "CoffeeBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>VOUS ETES LE MIXEUR !</span></div>";
                break;
            case "FilingBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>VOUS ETES LE TRIEUR !</span></div>";
                break;
            case "CopierBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>FIXEZ L'IMPRIMANTE !</span></div>";
                break;
            case "KeypadBomb":
                n += "<div class='bomb-header' id='instruction-header'><span>CRACKEZ LE CODE !</span></div>";
                break
        }
        this.$el.find(`#${e}`).html(n)
    },
